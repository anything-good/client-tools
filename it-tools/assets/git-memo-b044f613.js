import{o,e as s,a1 as r,d as l,bx as i,i as m,g as a,a0 as p,A as g}from"./index-41a18eb3.js";const d={class:"markdown-body"},h=r(`<h2>Configuration</h2><p>Set the global config</p><pre><code class="language-shell">git config --global user.name &quot;[name]&quot;
...
</code></pre>`,27),_=[h],u={__name:"git-memo.content",setup(c,{expose:e}){return e({frontmatter:{}}),(n,b)=>(o(),s("div",d,_))}},f=l({__name:"git-memo",setup(c){p(t=>({"8cb22b3c":a(e).cardColor}));const e=i();return(t,n)=>(o(),s("div",null,[m(a(u))]))}});const C=g(f,[["__scopeId","data-v-c7dbeca3"]]);export{C as default};
